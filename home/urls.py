...
urlpatterns = [
    ...
    path('AddAuthorSubmission/', views.AddAuthorSubmission, name='AddAuthorSubmission'),
    path('addcategory/', views.addcategory, name='addcategory'),
    path('AddCategorySubmission/', views.AddCategorySubmission, name='AddCategorySubmission'),
    path('addpublisher/', views.addpublisher, name='addpublisher'),
    path('AddPublisherSubmission/', views.AddPublisherSubmission, name='AddPublisherSubmission'),
